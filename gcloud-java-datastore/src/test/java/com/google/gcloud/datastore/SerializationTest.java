...
public class SerializationTest {
  ...
  private static final NullValue NULL_VALUE = NullValue.builder().excludeFromIndexes(false).build();
  ...
  private static final FullEntity<IncompleteKey> EMBEDDED_ENTITY = Entity.builder(INCOMPLETE_KEY1)
      .set("p1", STRING_VALUE)
      .set("p2", LongValue.builder(100).excludeFromIndexed(true).meaning(100).build())
      .build();
